...
public class ImagesBundlesMapCachedSingleServiceImpl implements ImagesBundlesMapService {
    ...
    protected void start() {
        createInjector(new ResourcesImagesCachedSingleMapModule(), new AbstractModule() {
